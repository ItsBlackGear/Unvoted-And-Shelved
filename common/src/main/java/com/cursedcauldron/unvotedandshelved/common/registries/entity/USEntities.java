...
public class USEntities {
    ...
    public static final Supplier<EntityType<CopperGolem>> COPPER_GOLEM = create("copper_golem", EntityType.Builder.of(CopperGolem::new, MobCategory.MISC).sized(0.85F, 1.45F).clientTrackingRange(8));
    public static final Supplier<EntityType<OxidizedCopperGolem>> OXIDIZED_COPPER_GOLEM = create("oxidized_copper_golem", EntityType.Builder.of(OxidizedCopperGolem::new, MobCategory.MISC).sized(0.85F, 1.45F).clientTrackingRange(8));
