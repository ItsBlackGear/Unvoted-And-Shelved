...
public class CopperGolemModel<T extends CopperGolem> extends HierarchicalModel<T> {
    ...
    public void setupAnim(T entity, float angle, float distance, float animationProgress, float yaw, float pitch) {
        ...
        this.animate(entity.walkingAnimation, CopperGolemAnimations.walkingAnimation(entity.getWeatherState()), animationProgress, speed);
...
//        this.animate(entity.headSpinSlowestAnimation, CopperGolemAnimations.HEAD_SPIN_SLOWEST, animationProgress);
        ...
        this.animate(entity.interactingAnimation, CopperGolemAnimations.BUTTON_PRESS, animationProgress);
...
//        this.animate(entity.buttonSlowestAnimation, CopperGolemAnimations.BUTTON_PRESS, animationProgress);
        ...
        this.animate(entity.interactingAboveAnimation, CopperGolemAnimations.BUTTON_PRESS_UP, animationProgress);
...
//        this.animate(entity.buttonUpSlowestAnimation, CopperGolemAnimations.BUTTON_PRESS_UP, animationProgress);
        ...
        this.animate(entity.interactingBelowAnimation, CopperGolemAnimations.BUTTON_PRESS_DOWN, animationProgress);
