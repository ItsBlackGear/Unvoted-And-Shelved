package com.cursedcauldron.unvotedandshelved.core.platform.client.forge;
...
@Mod.EventBusSubscriber(modid = UnvotedAndShelved.MOD_ID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.MOD)
